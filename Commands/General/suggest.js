...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await guild.channels.cache.get('1035986726893666385').send({
            embeds: ([embed]),
        }).then((s) => {
            s.react('✅');
            s.react('❌');
        ...
        interaction.reply({ content: ":white_check_mark: | Your suggestion has been succesfully submitted ✉️ .", ephemeral: true });
    }
}